...
# PAT-E05-F01 — Document Quality Check
...
- **Шаг:** 1
- **Экран:** Document Quality Check
- **Действия пользователя:** Видит превью загруженного документа
- **Данные системы:** documentPreviewUrl
- **Happy path:** Видит превью на полный экран
- **JTBD:** Убедиться что документ читаемый
...
- **default** — Базовый вид экрана «Document Quality Check» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `documentPreviewUrl`
...
- [ ] Превью занимает основную область
- [ ] есть toolbar с actions
