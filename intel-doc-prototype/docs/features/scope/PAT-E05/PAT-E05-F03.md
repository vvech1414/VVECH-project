...
- **Шаг:** 3
- **Экран:** Quality warning
- **Действия пользователя:** Видит предупреждение при низком качестве
- **Данные системы:** qualityScore<threshold
- **Happy path:** Видит amber-warning «Документ может быть нечитаем»
- **JTBD:** Понять риски до отправки в OCR
...
- **default** — Базовый вид экрана «Quality warning» с заполненными mock-данными.
...
Сырые поля из источника: `qualityScore<threshold`
...
**Хорошие примеры:**
- «Проверьте читаемость документа»
- «Документ может быть нечитаем»
...
- [ ] Warning виден
- [ ] не блокирует
- [ ] предлагает retake или save-as-original
...
- **Кандидаты файлов:** `src/routes/patient/UploadFlow.tsx`
