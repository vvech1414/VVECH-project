...
- **Шаг:** 4
- **Экран:** Disclaimer плана
- **Действия пользователя:** Видит supportive дисклеймер
- **Данные системы:** disclaimerVersion
- **Happy path:** Видит «Это не заменяет консультацию врача»
- **JTBD:** Понимать что план — это запрос данных, не лечение
...
- **default** — Базовый вид экрана «Disclaimer плана» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `disclaimerVersion`
