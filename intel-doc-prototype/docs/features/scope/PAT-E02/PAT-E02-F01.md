...
# PAT-E02-F01 — Header главного экрана
...
- **Шаг:** 1
- **Экран:** Header главного экрана
- **Действия пользователя:** Открывает главный; смотрит шапку с брендом и партнёром
- **Данные системы:** brand=IntelDoc, partner=ЭНЦ, unreadCount, profileAvatar
- **Happy path:** Видит co-brand IntelDoc + ЭНЦ; видит индикатор уведомлений и иконку профиля
- **JTBD:** Сразу убедиться в правильном медицинском контексте
...
- **default** — Базовый вид экрана «Header главного экрана» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `brand=IntelDoc, partner=ЭНЦ, unreadCount, profileAvatar`
...
```ts
{
  ...
  partner: "ЭНЦ",
  unreadCount: 2,
  profileAvatar: "/avatars/maria.png",
}
```
