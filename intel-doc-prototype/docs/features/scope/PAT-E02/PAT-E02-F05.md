...
- **Шаг:** 5
- **Экран:** Bottom navigation
- **Действия пользователя:** Использует bottom nav для перехода между разделами
- **Данные системы:** navItems: home, history, plan, profile
- **Happy path:** Перемещается между главной / историей / планом / профилем
- **JTBD:** Свободно перемещаться по приложению
...
- **default** — Базовый вид экрана «Bottom navigation» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `navItems: home, history, plan, profile`
