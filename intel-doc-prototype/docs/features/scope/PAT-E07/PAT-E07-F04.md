...
# PAT-E07-F04 — Empty state истории
...
- **Шаг:** 4
- **Экран:** Empty state истории
- **Действия пользователя:** Видит историю без анализов
- **Данные системы:** analyses=[]
- **Happy path:** Видит calm-empty с CTA «Загрузить анализ»
- **JTBD:** Понять что история пуста и что делать
...
- **default** — Базовый вид экрана «Empty state истории» с заполненными mock-данными.
...
Сырые поля из источника: `analyses=[]`
