...
screen: Список истории с фильтрами
step: 2
state: default
priority: Must-have
must_demo: true
...
# PAT-E07-F02 — Список истории с фильтрами
...
- **Шаг:** 2
- **Экран:** Список истории с фильтрами
- **Действия пользователя:** Открывает историю и фильтрует по периоду/типу
- **Данные системы:** filters: {period, type, search}
- **Happy path:** Видит список карточек с базовыми фильтрами
- **JTBD:** Найти конкретный анализ быстро
...
- **default** — Базовый вид экрана «Список истории с фильтрами» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `filters: {period, type, search}`
...
- [ ] Поиск
- [ ] фильтры по периоду и типу работают
...
- **Кандидаты файлов:** `src/routes/patient/History.tsx`
