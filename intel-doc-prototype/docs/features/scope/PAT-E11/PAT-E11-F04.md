...
- **Шаг:** 4
- **Экран:** Состояние «новое»
- **Действия пользователя:** Видит индикатор unread
- **Данные системы:** unreadCount>0
- **Happy path:** Видит badge на иконке колокольчика
- **JTBD:** Не пропустить новое
...
- **default** — Базовый вид экрана «Состояние «новое»» с заполненными mock-данными. ★ обязательно для демо
...
Сырые поля из источника: `unreadCount>0`
...
- [ ] Badge виден в шапке (PAT-E02-F01)
- [ ] сбрасывается при открытии
